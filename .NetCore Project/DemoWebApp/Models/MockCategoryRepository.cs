...
namespace DemoWebApp.Models
{
    public class MockCategoryRepository : ICategoryRepository
    {
        public IEnumerable<Category> AllCategories => 
            new List<Category>
            {
                new Category{ CategoryId = 1, CategoryName = "Fruit Pies", Description = "All fruit mixed flavoured taste pies."},
                new Category{ CategoryId = 2, CategoryName = "Chocolate Pies", Description = "Cocoa roasted dark creamed chocolate pie."},
                new Category{ CategoryId = 3, CategoryName = "Blueberry Pies", Description = "Special ordered blueberry from swizerland flavoured pie."},
                new Category{ CategoryId = 4, CategoryName = "ButterScotch Pies", Description = "All new indian made buttercoth flavour layered pie."}
            };
    }
